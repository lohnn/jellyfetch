...
private val sampleItems = listOf(
    LibraryItem(id = "1", name = "The Matrix", year = 1999, type = LibraryItemType.MOVIE),
    LibraryItem(id = "2", name = "Game of Thrones", year = 2011, type = LibraryItemType.SERIES),
    LibraryItem(id = "3", name = "Blade Runner 2049", year = 2017, type = LibraryItemType.MOVIE),
    LibraryItem(id = "4", name = "Skavlan", year = 2009, type = LibraryItemType.SERIES),
)
